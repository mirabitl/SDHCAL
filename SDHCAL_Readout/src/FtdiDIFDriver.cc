...
int32_t FtdiDIFDriver::SetControlRegister(int32_t tvalue)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
...
int32_t FtdiDIFDriver::GetControlRegister(uint32_t *tvalue)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
...
int32_t  FtdiDIFDriver::HardrocGetTimerHoldRegister(uint32_t *thold)    throw (LocalHardwareException)
{
	int32_t taddress=0x20;
...
int32_t FtdiDIFDriver::HardrocSetNumericalReadoutMode(int32_t tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocGetNumericalReadoutMode(int32_t *tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocSetNumericalReadoutStartMode(int32_t tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocGetNumericalReadoutStartMode(int32_t *tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocSetSCOverVoltageDefault(void)
throw (LocalHardwareException)
{
	uint32_t taddress;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocGetSCOverVoltage(int32_t *tmode)
throw (LocalHardwareException)
{
	uint32_t taddress;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocSetTestAllAsicsDefault(void)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocGetTestAllAsics(int32_t *tmode)    throw (LocalHardwareException)
{
	uint32_t taddress =0x03;
	uint32_t tdata;
...
int32_t FtdiDIFDriver::HardrocSetEnablePowerPulsing(int32_t tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
	try	{		UsbRegisterRead(taddress,&tdata);	}
...
int32_t FtdiDIFDriver::HardrocGetEnablePowerPulsing(int32_t *tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
	try	{		UsbRegisterRead(taddress,&tdata);	}
...
int32_t FtdiDIFDriver::HardrocSetEnableTimeoutDigitalReadout(int32_t tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
	try	{		UsbRegisterRead(taddress,&tdata);	}
...
int32_t FtdiDIFDriver::HardrocGetEnableTimeoutDigitalReadout(int32_t *tmode)    throw (LocalHardwareException)
{
	uint32_t taddress=0x03;
	uint32_t tdata;
	try	{		UsbRegisterRead(taddress,&tdata);	}
...
int32_t FtdiDIFDriver::HardrocGetStatusRegister(uint32_t *tstatus)    throw (LocalHardwareException)
{
	uint32_t taddress=0x04;
	try	{		UsbRegisterRead(taddress,tstatus);	}
	catch (LocalHardwareException& e) { std::cout<<e.message()<<std::endl;throw (e); return -1; }
...
int32_t FtdiDIFDriver::HardrocGetMemFull(uint32_t *tstatus)    throw (LocalHardwareException)
{
	uint32_t taddress;
...
int32_t FtdiDIFDriver::HardrocGetRamFullCpt(uint32_t *tstatus)    throw (LocalHardwareException)
{
...
int32_t FtdiDIFDriver::HardrocSetSCDebugRegister(int32_t tvalue)    throw (LocalHardwareException)
{
...
int32_t FtdiDIFDriver::HardrocGetSCDebugRegister(uint32_t *tvalue)    throw (LocalHardwareException)
{
	uint32_t taddress=0x19;
...
int32_t FtdiDIFDriver::SetChipTypeRegister(int32_t tvalue)    throw (LocalHardwareException)
{
...
int32_t FtdiDIFDriver::GetChipTypeRegister(uint32_t *tvalue)    throw (LocalHardwareException)
{
	uint32_t taddress=0x0;
...
/*cc 3011
int32_t FtdiDIFDriver::SetResetCounter(int32_t tvalue)    throw (LocalHardwareException)
{
uint32_t taddress=0x03;
uint32_t tampon;
...
int32_t FtdiDIFDriver::GetResetCounter(uint32_t *tvalue)    throw (LocalHardwareException)
{
uint32_t taddress=0x03;
...
int32_t FtdiDIFDriver::SetEventsBetweenTemperatureReadout(uint32_t tdata)    throw (LocalHardwareException)
{
...
int32_t FtdiDIFDriver::GetEventsBetweenTemperatureReadout(uint32_t *tdata)    throw (LocalHardwareException)
{
	uint32_t taddress=0x55;
	try{	UsbRegisterRead(taddress,tdata);	}
	catch (LocalHardwareException& e)
...
int32_t FtdiDIFDriver::SetAnalogConfigureRegister(uint32_t tdata)    throw (LocalHardwareException)
{
