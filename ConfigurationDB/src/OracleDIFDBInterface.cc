...
#include <map>
OracleDIFDBInterface::OracleDIFDBInterface(State* s ) : _state(s)
{}
void OracleDIFDBInterface::initialize()
{}

void OracleDIFDBInterface::LoadDIFDefaultParameters(uint32_t difid, UsbDIFSettings* v)
{
...
#undef BUGINDB
uint32_t OracleDIFDBInterface::LoadDIFHardrocV2Parameters(uint32_t difid_request,SingleHardrocV2ConfigurationFrame* ConfigHR2)
{
  uint8_t thr=0;
	uint8_t thrl1=0;
	uint8_t thrl2=0;
...
uint32_t OracleDIFDBInterface::LoadDIFMicrorocParameters(uint32_t difid, SingleHardrocV2ConfigurationFrame* ConfigMR)
{
  uint8_t tmr=0;  // thr
	uint8_t tmrl1=0;
	uint8_t tmrl2=0;
...
void OracleDIFDBInterface::storeHardRoc2Configuration(Asic* itHR2,unsigned char* ConfigHR2)
{
  unsigned long long tmask0;
  unsigned long long tmask1;
  unsigned long long tmask2;
...
void OracleDIFDBInterface::storeMicroRocConfiguration(Asic* itMR,unsigned char* ConfigMR)
{
  unsigned long long mask0;
  unsigned long long mask1;
  unsigned long long mask2;
...
uint32_t OracleDIFDBInterface::LoadAsicParameters()
{
