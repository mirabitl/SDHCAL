...
void BMP183::myAnalogWrite (struct wiringPiNodeStruct *node, int addr, int value)
{
  unsigned char spiData [2] ;
...
int BMP183::myAnalogRead (struct wiringPiNodeStruct *node, int addr)
{
  unsigned char spiData [2] ;
...
int BMP183::BMP183GetCalibration(void)
{ 
  int tlsb, tmsb;
...
float BMP183::BMP183TemperatureRead(void)
{
...
float BMP183::BMP183PressionRead(void)
{
  float pression;
